...
<!--            </div>-->
        ...
        <div class="row sticky-top" style="top: 2vw; margin-top: 10px">

            <div class="col d-flex justify-content-between genreHeadings sticky-top" style="top: 2vw; color:#b66631; padding-left: 8vw; padding-right: 8vw">
