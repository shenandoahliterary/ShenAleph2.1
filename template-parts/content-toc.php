...
<section class="container">
    <div class="row cover-row d-flex">
        ...
        <div class="col-4">
            <div class="align-self-center volumeIssueImage" style="background-color:#303B35">
                Volume 72, Number 1 &middot; Fall 2022
            </div>
        </div>

        <div class="col-8">
            <img style="margin-left: -3vw; padding-top:1vw" src="<?php echo get_stylesheet_directory_uri(); ?>/cover1.jpg" alt="" itemprop="">
