...
<div id="page" class="site">
	...
	<section class="topbanner-noborder container-fluid typelogo-container">
		...
		<div class="d-flex justify-content-center" style="margin-bottom: -5vw">
            <img style="width:10%; height:75%;" src="<?php echo get_stylesheet_directory_uri(); ?>/Shenandoah-1600.jpg" alt="Shenandoah Logo" itemprop="logo">
            <p id="typelogo">
		...
		<div class="row nav-bar-row" style="padding-top:15px">
			...
			<div class="d-flex flex-nowrap col-md-6 float-md-end nav-bar" role="navigation" style="background-color:rgb(103,173,168)">
