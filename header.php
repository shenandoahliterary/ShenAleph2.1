...
<div id="page" class="site">
	...
	<section class="topbanner-noborder container-fluid">
		...
		<div class="d-flex justify-content-center align-content-center" style="background-color: white">
            <img style="width:8vw; height:auto" src="<?php echo get_stylesheet_directory_uri(); ?>/Shenandoah-1600.jpg" alt="Shenandoah Logo" itemprop="logo">
            <p id="typelogo">
